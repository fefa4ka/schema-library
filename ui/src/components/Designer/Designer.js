...
import { default as InsertMenu } from './panels/InsertMenu';
import { default as SVGRenderer } from './SVGRenderer';
import { default as Handler } from './Handler';
import {modes} from './constants';
import * as actions from './actions';
import {Text, Path, Rect, Circle, Image, Part} from './objects';
import { default as PanelList } from './panels/PanelList';
      ...
      <HotKeys
        ...
        <div className={'container'}
          ...
          {/* Center Panel: Displays the preview */}
            <div style={styles.canvasContainer} className='Designer-Container'>
